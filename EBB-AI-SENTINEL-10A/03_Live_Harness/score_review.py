#!/usr/bin/env python3
"""Join locked SENTINEL-10A blind review with the hidden key and compute the RC2.8 release gate."""
...
p.add_argument('--out',default='EBB-AI-SENTINEL-10A_REVIEW_SCORE.json')
a=p.parse_args()
