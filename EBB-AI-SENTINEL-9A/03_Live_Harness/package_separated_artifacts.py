#!/usr/bin/env python3
"""Create non-overlapping strict blind and custodian ZIPs after successful SENTINEL-9A validation."""
...
blind_readme.write_text(
    'SENTINEL-9A STRICT BLIND REVIEW ARTIFACT\\n'
...
blind_zip=out/'sentinel9a-blind-review.zip'
...
cust_zip=out/'sentinel9a-custodian-results.zip'
