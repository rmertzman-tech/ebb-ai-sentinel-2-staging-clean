...
PREFIX='EBB-AI-SENTINEL-9A'; BASE='baseline_rc2_6'; CAND='candidate_rc2_7'
HIGH_RISK={'P01-A','P01-B','P02-B','P03-A','P03-B','P04-B','P06-A','P06-B','P12-B'}
EXPECTED_CAPTURED='3d6fda8264fc221053f5385351e3f5a732b9193f6a330daf5caba30ac516a911'
...
MARKERS=["EVIDENCE-MINIMAL OUTPUT CONTRACT — NO-MECHANISM DEFAULT:", "SAFETY-STATE ECHO — REQUIRED ON UNRESOLVED POST-SAFETY CLARIFICATION:", "NEUTRAL-QUESTION REWRITE GATE — NO MODEL-SUPPLIED ALTERNATIVES:"]
checks=[]
