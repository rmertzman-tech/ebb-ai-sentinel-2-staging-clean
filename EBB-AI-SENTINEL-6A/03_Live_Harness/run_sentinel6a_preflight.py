#!/usr/bin/env python3
"""Fail-closed SENTINEL-6A preflight. No network calls."""
from pathlib import Path
import json,csv,hashlib,subprocess,tempfile,sys
ROOT=Path(__file__).resolve().parents[1]
PREFIX='EBB-AI-SENTINEL-6A'
BASE='baseline_rc2_3'
CAND='candidate_rc2_4'
HIGH_RISK={'P06-A', 'P01-B', 'P02-B', 'P12-B', 'P04-B', 'P01-A', 'P03-A', 'P06-B', 'P03-B'}
EXPECTED_CAPTURED='8b9be501a37887b9fc1eb1864040a863936c6fb14a84d9420470402611327697'
...
EXPECTED_BUILDS={
  ...
  "EBB-AI-SENTINEL-6_EXAMINED_RC2.4_STRUCTURAL_RESIDUAL.zip": "6846a32d9c0b09285ca9c4657c6f2a30d925244bde19fe6490bee2614f0fea57",
  "EBB-AI-SENTINEL-6_NAVIGATOR_RC2.4_STRUCTURAL_RESIDUAL.zip": "6792f7ee33b702631a1bfb595b43ec12f032900b81a2afb6feda5b208ddbbb75",
}
...
# Explicit token test condition: instruction may contain token text, but messages must not inject it.
