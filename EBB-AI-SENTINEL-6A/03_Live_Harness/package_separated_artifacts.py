#!/usr/bin/env python3
"""Create non-overlapping strict blind and custodian ZIPs after successful SENTINEL-6A validation."""
...
blind_readme.write_text(
    'SENTINEL-6A STRICT BLIND REVIEW ARTIFACT\\n'
...
blind_zip=out/'sentinel6a-blind-review.zip'
...
cust_zip=out/'sentinel6a-custodian-results.zip'
