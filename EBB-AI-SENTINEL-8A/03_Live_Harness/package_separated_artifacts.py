#!/usr/bin/env python3
"""Create non-overlapping strict blind and custodian ZIPs after successful SENTINEL-8A validation."""
...
blind_readme.write_text(
    'SENTINEL-8A STRICT BLIND REVIEW ARTIFACT\\n'
...
blind_zip=out/'sentinel8a-blind-review.zip'
...
cust_zip=out/'sentinel8a-custodian-results.zip'
