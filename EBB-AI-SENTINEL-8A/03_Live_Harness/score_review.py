#!/usr/bin/env python3
"""Join locked SENTINEL-8A blind review with the hidden key and compute the RC2.6 release gate."""
...
p.add_argument('--out',default='EBB-AI-SENTINEL-8A_REVIEW_SCORE.json')
a=p.parse_args()
