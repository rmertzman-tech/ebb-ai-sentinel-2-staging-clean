#!/usr/bin/env python3
"""Create non-overlapping strict blind and custodian ZIPs after successful SENTINEL-7A validation."""
...
blind_readme.write_text(
    'SENTINEL-7A STRICT BLIND REVIEW ARTIFACT\\n'
...
blind_zip=out/'sentinel7a-blind-review.zip'
...
cust_zip=out/'sentinel7a-custodian-results.zip'
