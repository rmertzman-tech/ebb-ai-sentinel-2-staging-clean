#!/usr/bin/env python3
"""EBB-AI-SENTINEL-7A production-compatible RC2.4 vs RC2.5 live certification runner.

Full mode executes 96 primary records plus 51 RC2.5 high-risk repeats = 147 total.
...
BASELINE_VERSION='baseline_rc2_4'
CANDIDATE_VERSION='candidate_rc2_5'
HIGH_RISK={'P06-A', 'P01-B', 'P02-B', 'P12-B', 'P04-B', 'P01-A', 'P03-A', 'P06-B', 'P03-B'}
PREFIX='EBB-AI-SENTINEL-7A'
