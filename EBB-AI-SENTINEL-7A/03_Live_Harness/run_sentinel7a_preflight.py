#!/usr/bin/env python3
"""Fail-closed SENTINEL-7A preflight. No network calls."""
from pathlib import Path
import json,csv,hashlib,subprocess,tempfile,sys
ROOT=Path(__file__).resolve().parents[1]
PREFIX='EBB-AI-SENTINEL-7A'
BASE='baseline_rc2_4'
CAND='candidate_rc2_5'
HIGH_RISK={'P06-A', 'P01-B', 'P02-B', 'P12-B', 'P04-B', 'P01-A', 'P03-A', 'P06-B', 'P03-B'}
EXPECTED_CAPTURED='74149d5b0d1aae41ae2a907f1f1def29693fe54614fa923c5d1c2015a38808e5'
