#!/usr/bin/env python3
"""Create non-overlapping strict blind and custodian ZIPs after successful SENTINEL-5A validation."""
...
blind_readme.write_text(
    'SENTINEL-5A STRICT BLIND REVIEW ARTIFACT\\n'
...
blind_zip=out/'sentinel5a-blind-review.zip'
...
cust_zip=out/'sentinel5a-custodian-results.zip'
