#!/usr/bin/env python3
"""Create non-overlapping strict blind and custodian ZIPs after successful SENTINEL-10A validation."""
...
blind_readme.write_text(
    'SENTINEL-10A STRICT BLIND REVIEW ARTIFACT\\n'
...
blind_zip=out/'sentinel11a-blind-review.zip'
...
cust_zip=out/'sentinel11a-custodian-results.zip'
