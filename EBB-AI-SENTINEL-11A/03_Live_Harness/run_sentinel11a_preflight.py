...
PREFIX='EBB-AI-SENTINEL-11A'; BASE='baseline_rc2_8'; CAND='candidate_rc2_9'
HIGH_RISK={'P01-A','P01-B','P02-B','P03-A','P03-B','P04-B','P06-A','P06-B','P12-B'}
EXPECTED_CAPTURED='3abc2687e20c25b9c54b0190a5933000d9f08decee2d22e833a663ff5bea1a8c'
...
EXPECTED_BUILDS={
  ...
  "EBB-AI-SENTINEL-11_EXAMINED_RC2.9_ACTIVATION_SUCCESS_LOYALTY.zip": "58ec3e29bb8d558e03924dfdf8880d3f90281403a56054389e4cf7d36cbaba2a",
  "EBB-AI-SENTINEL-11_NAVIGATOR_RC2.9_ACTIVATION_SUCCESS_LOYALTY.zip": "427a56d87f9f87c1f152fd02cbe0e16d6b5a88777de2a60b00fa1be9479e7f89",
}
MARKERS=['EXPLICIT SAFETY-ACTIVATION STANDING — USER REPORT COUNTS AS PROVENANCE:', 'CLEAN-SUCCESS NO-BREAKDOWN CLAMP — NO HIDDEN REPAIR OR FUTURE FAILURE:', 'LOYALTY LITERALISM LOCK — VALUE WITHOUT PSYCHOLOGICAL FUNCTION:']
checks=[]
