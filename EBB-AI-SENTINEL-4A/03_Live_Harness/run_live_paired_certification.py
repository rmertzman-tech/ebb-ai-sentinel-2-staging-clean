#!/usr/bin/env python3
"""EBB-AI-SENTINEL-4A production-compatible RC2.1 vs RC2.2 live certification runner.

Full mode executes 96 primary records plus 51 RC2.2 high-risk repeats = 147 total.
...
BASELINE_VERSION='baseline_rc2_1'
CANDIDATE_VERSION='candidate_rc2_2'
