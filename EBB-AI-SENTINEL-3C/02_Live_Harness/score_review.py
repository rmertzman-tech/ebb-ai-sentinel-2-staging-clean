#!/usr/bin/env python3
"""Join locked SENTINEL-3C blind review with the hidden key and compute the RC2.1 release gate."""
...
p.add_argument('--out',default='EBB-AI-SENTINEL-3C_REVIEW_SCORE.json')
a=p.parse_args()
