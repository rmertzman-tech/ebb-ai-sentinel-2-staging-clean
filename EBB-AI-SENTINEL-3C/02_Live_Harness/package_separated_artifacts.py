#!/usr/bin/env python3
"""Create non-overlapping strict blind and custodian ZIPs after successful SENTINEL-3C validation."""
...
blind_readme.write_text(
    'SENTINEL-3C STRICT BLIND REVIEW ARTIFACT\\n'
...
blind_zip=out/'sentinel3c-blind-review.zip'
...
cust_zip=out/'sentinel3c-custodian-results.zip'
